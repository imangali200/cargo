<template>
  <header class="tw-h-[70px] tw-flex tw-items-center">
    <div
      class="tw-flex tw-items-center tw-px-5 md:tw-px-24 tw-justify-between tw-w-full"
    >
      <img
    ...
    <v-app>
      ...
      >
        ...
        <v-list style="padding-top: 40px">
          ...
          <v-list-item class="v-list-item" >
            <nuxt-link to="/admin/"><v-list-item-title>Users</v-list-item-title></nuxt-link>
          </v-list-item>
          <v-list-item class="v-list-item">
